        ...
        <div class="card p-5">
            ...
            @php
                ...
                if (!is_array($selectedServiceIds)) {
                    $selectedServiceIds = $appointment->service_ids ?: [$appointment->service_id];
                }
            @endphp
            ...
            <!-- Выбор услуг (dropdown) -->
                ...
                <div class="mb-5">
                    ...
                    <input type="tel" name="client_phone" id="client_phone" value="{{ old('client_phone', $appointment->client_phone) }}"
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="start_time" id="start_time"
                           value="{{ old('start_time', $appointment->start_time->format('Y-m-d H:i')) }}" required readonly
                ...
                <div class="mb-6">
                    ...
                    <textarea name="notes" id="notes" rows="4"
                              class="input-field" placeholder="Дополнительная информация...">{{ old('notes', $appointment->notes) }}</textarea>
                </div>
            ...
            document.addEventListener('DOMContentLoaded', function () {
                ...
                async function saveOffline(data) {
                    try {
                        ...
                        alert('Нет интернета. Изменения сохранены локально. Они будут отправлены автоматически при появлении интернета.');
                        window.location.href = '{{ route('appointments.index') }}';
                    } catch (error) {
                        console.error('Ошибка сохранения офлайн:', error);
                        alert('Не удалось сохранить изменения офлайн.');
                    }
                }
