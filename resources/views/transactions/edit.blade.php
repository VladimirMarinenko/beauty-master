        ...
        <div class="card p-5">
            <form action="{{ route('transactions.update', $transaction) }}" method="POST">
                ...
                <div class="mb-5">
                    ...
                    <input type="number" step="0.01" min="0" name="amount" id="amount" value="{{ old('amount', $transaction->amount) }}" required
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="transaction_date" id="transaction_date"
                           value="{{ old('transaction_date', $transaction->transaction_date->format('Y-m-d H:i')) }}" required
                ...
                <div class="mb-5">
                    ...
                    <textarea name="description" id="description" rows="4"
                              class="input-field" placeholder="Дополнительная информация...">{{ old('description', $transaction->description) }}</textarea>
                </div>
            ...
            <form action="{{ route('transactions.destroy', $transaction) }}" method="POST" class="mt-4" onsubmit="return confirm('Удалить транзакцию?')">
                @csrf
                @method('DELETE')
